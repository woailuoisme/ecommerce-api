...
/**
 * @link https://stackoverflow.com/questions/27204485/synchronizing-a-one-to-many-relationship-in-laravel
...
class HasManySyncable extends HasMany
{
    public function sync($data, $deleting = true)
    {
        ...
        foreach ($data as $row) {
            ...
            if (isset($row[$relatedKeyName]) && !empty($row[$relatedKeyName]) && in_array($row[$relatedKeyName],
                    $current)) {
